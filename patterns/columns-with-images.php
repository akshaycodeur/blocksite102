 ...
 * Slug: blocksite102/columns-with-images
 * Categories: featured
...
<!-- wp:columns {"align":"wide"} -->
	<div class="wp-block-columns alignwide"><!-- wp:column -->
		...
		<p class="has-text-align-center"><?php echo esc_html_x( 'Sample content. Replace the text with your own content.', 'sample content', 'blocksite102' ); ?></p>
		<!-- /wp:paragraph --></div>
		<!-- /wp:column -->
		<!-- wp:column -->
