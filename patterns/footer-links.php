...
/**
 * Title: Footer links
 * Slug: blocksite102/footer-links
 * Categories: text
 * Inserter: no
 *
...
<p class="has-extra-small-font-size"><?php esc_html_e( 'Copyright', 'blocksite102' );
echo ' ' . date_i18n( _x( 'Y', 'copyright date format', 'blocksite102' ) ); ?></p><!-- /wp:paragraph -->
<!-- wp:site-title {"level":0, "fontSize":"extra-small"} /-->
<?php echo blocksite102_privacy(); ?>
